...
pygame.display.set_caption("Bug Fix!")

pygame.mixer.init()
sounda = pygame.mixer.Sound("final_game_music.wav")
...
font = pygame.font.Font('Font-Regular.ttf', 20)
text = font.render('Bug Fix!   A game by Henry Achin', True, text, background)
